...
public class Phase2StunnedShadowLordState : EnemyState
{ 
    private ShadowLord enemy;

    public Phase2StunnedShadowLordState(Enemy enemyBase, EnemyStateMachine stateMachine, string animBoolName, ShadowLord enemy) : base(enemyBase, stateMachine, animBoolName)
    {
        this.enemy = enemy;
    }
