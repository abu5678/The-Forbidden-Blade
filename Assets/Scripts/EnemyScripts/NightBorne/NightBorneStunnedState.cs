...
public class NightBorneStunnedState : EnemyState
{
    ...
    public NightBorneStunnedState(Enemy enemyBase, EnemyStateMachine stateMachine, string animBoolName,NightBorne enemy) : base(enemyBase, stateMachine, animBoolName)
    {
        this.enemy = enemy;
    }
