...
public class ShadowLordStunnedState : EnemyState
{ 
    private ShadowLord enemy;

    public ShadowLordStunnedState(Enemy enemyBase, EnemyStateMachine stateMachine, string animBoolName, ShadowLord enemy) : base(enemyBase, stateMachine, animBoolName)
    {
        this.enemy = enemy;
    }
