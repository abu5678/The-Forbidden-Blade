...
public class ShadowLordMoveState : ShadowLordGroundedState
{
    public ShadowLordMoveState(Enemy enemyBase, EnemyStateMachine stateMachine, string animBoolName, ShadowLord enemy) : base(enemyBase, stateMachine, animBoolName, enemy)
    {
    }
